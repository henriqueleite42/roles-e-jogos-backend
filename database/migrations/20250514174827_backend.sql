...
CREATE TABLE "accounts" ("avatar_path" character varying(128) NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "handle" character varying(16) NOT NULL, "id" integer NOT NULL GENERATED ALWAYS AS IDENTITY, "is_admin" boolean NOT NULL DEFAULT false, "name" character varying(64) NULL, PRIMARY KEY ("id"));
-- Create index "accounts_handle_idx" to table: "accounts"
CREATE UNIQUE INDEX "accounts_handle_idx" ON "accounts" ("handle");
-- Create "connections" table
CREATE TABLE "connections" ("access_token" character varying(500) NULL, "account_id" integer NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "external_handle" character varying(30) NULL, "external_id" character varying(255) NOT NULL, "provider" "provider_enum" NOT NULL, "refresh_token" character varying(500) NULL, PRIMARY KEY ("external_id", "provider"), CONSTRAINT "connections_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "accounts" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "event_attendances" ("account_id" integer NOT NULL, "confirmed_at" timestamptz NOT NULL DEFAULT now(), "event_id" integer NOT NULL, "id" integer NOT NULL GENERATED ALWAYS AS IDENTITY, "status" "event_attendance_status_enum" NOT NULL, PRIMARY KEY ("account_id", "event_id", "id"), CONSTRAINT "event_attendances_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "accounts" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "event_attendances_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "events" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
-- Create "games" table
CREATE TABLE "games" ("average_duration" integer NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "description" character varying(1000) NOT NULL, "icon_path" character varying(256) NULL, "id" integer NOT NULL GENERATED ALWAYS AS IDENTITY, "kind" "kind_enum" NOT NULL, "ludopedia_id" integer NULL, "ludopedia_url" character varying(512) NULL, "max_amount_of_players" integer NOT NULL, "min_age" integer NOT NULL, "min_amount_of_players" integer NOT NULL, "name" character varying(128) NOT NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "sessions" ("account_id" integer NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "session_id" character(128) NOT NULL, PRIMARY KEY ("session_id"), CONSTRAINT "sessions_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "accounts" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
